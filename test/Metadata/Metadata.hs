        ...
        , testXML "test/Metadata/metadata-osf.xml" $
            EntityDescriptor
                ...
                ( Extensions $
                    let alg t a =
                            HXT.mkElement
                                (HXT.mkQName "alg" (t ++ "Method") "urn:oasis:names:tc:SAML:metadata:algsupport")
                                [HXT.mkAttr (HXT.mkName "Algorithm") [HXT.mkText $ show $ identifier a]]
                                []
                     in [ alg "Digest" DS.DigestSHA512
                ...
                ( Descriptors
                    ( IDPSSODescriptor
                        ( RoleDescriptor
                            ...
                            ( Extensions
                                [ HXT.mkElement
                                    (HXT.mkQName "shibmd" "Scope" "urn:mace:shibboleth:metadata:1.0")
