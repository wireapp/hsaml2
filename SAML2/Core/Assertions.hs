...
instance XP.XmlPickler SubjectConfirmationData where
  xpickle =
    xpElem "SubjectConfirmationData" $
      [XP.biCase|
...
data Condition
  = -- | §2.5.1.3
    Condition Node
  | -- | §2.5.1.4
    AudienceRestriction (List1 Audience)
  | -- | §2.5.1.5
    OneTimeUse
  | -- | §2.5.1.6
    ProxyRestriction
